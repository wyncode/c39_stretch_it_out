...
const StretchModal = (props) => {
  ...
  return (
    <Modal {...props} size="xl">
      ...
      <h3 className="stretch-modal-title">{props.target} Stretches</h3>
        ...
        <Dropdown as={ButtonGroup} className="dropdown-button">
          ...
          <Dropdown.Menu className="dropdown-menu" align="right">
            {['5 minutes', '10 minutes', '15 minutes'].map((len) => (
              <Dropdown.Item onClick={() => handleFilterChange('length', len)}>
                {len}
              </Dropdown.Item>
            ))}
          </Dropdown.Menu>
        ...
        <Dropdown as={ButtonGroup} className="dropdown-button">
          ...
          <Dropdown.Menu className="dropdown-menu" align="right">
            {['Beginner', 'Intermediate', 'Advanced'].map((level) => (
              <Dropdown.Item onClick={() => handleFilterChange('level', level)}>
                {level}
              </Dropdown.Item>
            ))}
          </Dropdown.Menu>
